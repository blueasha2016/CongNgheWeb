...
<p>&nbsp;</p>
<div class="error">Đăng ký thất bại!</div>
<p>Bạn thấy trang này bởi vì nỗ lực của bạn để tạo một tài khoản mới đã thất bại. Bạn đã sử dụng một địa chỉ email đã được sử dụng. <a href="login-register.php">Nhấn vào đây</a> để thử lại. Hoặc <a href="JavaScript: resetPassword()">Nhấn vào đây</a> để lấy lại mật khẩu của bạn.</p>
</div>
</div>
<div id="footer">
