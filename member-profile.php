...
<p>&nbsp;</p>
<p>Ở đây bạn có thể thay đổi mật khẩu cũng như địa chỉ giao hàng của mình. Địa chỉ giao hàng và các thông tin của bạn sẽ được chúng tôi sử dụng trong quá trình giao hàng và thanh toán giao dịch. Để biết thêm thông tin <a href="contactus.php">Nhấn vào đây</a> để liên lạc với chúng tôi.</p>
<hr>
<table width="870">
<tr>
...
<form id="billingForm" name="billingForm" method="post" action="billing-exec.php?id=<?php echo $_SESSION['SESS_MEMBER_ID'];?>" onsubmit="return billingValidate(this)">
  ...
  <CAPTION><h2>THÊM ĐỊA CHỈ GIAO DỊCH</h2></CAPTION>
	<tr>
		<td colspan="2" style="text-align:center;"><font color="#FF0000">* </font>Miền bắt buộc</td>
	</tr>
    <tr>
