...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2016 at 07:04 AM
...
CREATE TABLE IF NOT EXISTS `billing_details` (
  ...
  `P_O_Box_No` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `City` text NOT NULL,
  `Mobile_No` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Landline_No` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `currencies` (
  ...
  `currency_symbol` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `flag` int(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `food_details` (
  ...
  `food_name` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `food_description` text NOT NULL,
  `food_price` float NOT NULL,
  `food_photo` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `members` (
  ...
  `login` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `passwd` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
(15, 'Nguyá»…n HoÃ ng', 'QuÃ¢n', 'hoangquan@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 9, 'e377fbada15a330f9f55901b3f81e0d0');
...
CREATE TABLE IF NOT EXISTS `messages` (
  ...
  `message_from` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `partyhalls` (
  ...
  `partyhall_name` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'Ngày sinh của bạn là gì?'),
(9, 'Bạn thích chó hay mèo?'),
(10, 'Người yêu của bạn tên gì?'),
(11, 'Theo bạn con gà có mấy chân?'),
(12, 'Năm này bạn bao nhiêu tuổi?'),
(13, 'Bạn học lại mấy môn ở đại học?');
...
CREATE TABLE IF NOT EXISTS `ratings` (
  ...
  `rate_name` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`rate_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `specials` (
  ...
  `special_name` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `special_description` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `special_price` float NOT NULL,
  `special_start_date` date NOT NULL,
  `special_end_date` date NOT NULL,
  `special_photo` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `staff` (
  ...
  `Mobile_Tel` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`StaffID`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `tables` (
  ...
  `table_name` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `timezones` (
  ...
  `timezone_reference` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `flag` int(1) NOT NULL,
